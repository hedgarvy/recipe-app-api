...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        """Retrieve recipes for authenticared user."""
        tags = self.request.query_params.get('tags')
        ingredients = self.request.query_params.get('ingridients')
        ...
        if ingredients:
            ...
            queryset = queryset.filter(ingridients__id__in=ingredient_ids)
